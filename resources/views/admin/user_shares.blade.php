...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			<li class="/admin/active"><a href="/admin"><svg class="glyph stroked dashboard-dial"><use xlink:href="#stroked-dashboard-dial"></use></svg> Dashboard</a></li>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Shares List</div>
					<table class="table table-bordered">
						...
						<tbody>
							@foreach($shares as $share)
								<tr>
									<td><img src="{{ $share->share_content }}"></td>
									<td>{{ $share->share_title }}</td>
									<td>{{ $share->share_description }}</td>
									<td>{{ $share->users->name }}</td>
									<td>
										<a href="/admin/shares/delete/{{ $share->id }}" class="btn btn-danger">Delete</a>
									</td>
								</tr>
							@endforeach
						</tbody>
